                    ...
                    <div className="flex flex-col items-end gap-2 w-full md:w-auto">
                        <div className="text-right">
                            <p className="text-4xl font-bold text-white">
                                {typeof summary.currentPrice === 'number' ? `$${summary.currentPrice.toFixed(2)}` : 'N/A'}
                            </p>
                            <div className={`flex items-center justify-end gap-1 text-lg font-semibold ${summary.changePercent >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                                ...
                                <span>{typeof summary.changePercent === 'number' ? `${summary.changePercent.toFixed(2)}%` : 'N/A'}</span>
                            </div>
                        </div>
                        {onAddToPortfolio && (
                            <button
                                ...
                                disabled={isSaved}
                                className={`flex items-center px-4 py-2 rounded-lg font-semibold transition-all ${isSaved
